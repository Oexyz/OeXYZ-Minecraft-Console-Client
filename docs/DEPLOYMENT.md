...
```bash
curl -fsSL https://raw.githubusercontent.com/Oexyz/OeXYZ-Minecraft-Console-Client/v1.3.0/install.sh | sh -s -- --version 1.3.0 --verify-attestation
```
...
| Platform | Archive |
|---|---|
| Intel/AMD 64-bit Linux | `OeXYZ-Minecraft-Console-Client-v1.3.0-linux-x64.tar.gz` |
| ARM64 Linux / Raspberry Pi OS 64-bit | `OeXYZ-Minecraft-Console-Client-v1.3.0-linux-arm64.tar.gz` |

```bash
tar -xzf OeXYZ-Minecraft-Console-Client-v1.3.0-linux-x64.tar.gz
chmod 755 oexyz
./oexyz --help
./oexyz install-path
```
